...
public class RecipeContract {
    ...
    public static final String AUTHORITY = "com.example.recipebook.RecipeProvider";
    ...
    public static final Uri RECIPE_INGREDIENTS_URI = Uri.parse("content://"+AUTHORITY+"/recipe_ingredient/");
